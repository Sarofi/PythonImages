...
cmd{ii}.fn_clnp{2}='/Users/YunHan/Google Drive/WorkSpace/FHVMatlab/FHV.syntheticdata4hetero00.7/FHV.lmax10pmax5.clnp.txt';
cmd{ii}.fn_clnp{3}=['hetero.step7/' inputbasename '.eta2.clnp.txt'];
cmd{ii}.fn_clnp{4}='/Users/YunHan/Google Drive/WorkSpace/FHVMatlab/FHV.syntheticdata4hetero00.7/FHV.lmax10pmax5.clnp.perturbed.txt';
cmd{ii}.fn_nu=cell(Neta,1);
cmd{ii}.fn_nu{1}=['hetero.step7/' inputbasename '.eta1.nu.txt'];
cmd{ii}.fn_nu{2}='/Users/YunHan/Google Drive/WorkSpace/FHVMatlab/FHV.syntheticdata4hetero00.7//FHV.lmax10pmax5.nu.txt';
cmd{ii}.fn_nu{3}=['hetero.step7/' inputbasename '.eta2.nu.txt'];
cmd{ii}.fn_nu{4}='/Users/YunHan/Google Drive/WorkSpace/FHVMatlab/FHV.syntheticdata4hetero00.7/FHV.lmax10pmax5.nu.perturbed.txt';
