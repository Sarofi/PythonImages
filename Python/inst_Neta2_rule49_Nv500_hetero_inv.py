...
def inst_Neta2_rule49_Nv500_hetero_inv():
    ...
    cmd_dict['fn_Imagestack']='FHV.out.lmax10pmax5.Neta2.rule49.Nv500.pre4hetero.inv.Imagestack.mrc'
    ...
    #####################
    cmd.append({'operator':'quad_read_integration_rule','fn_rule':'rule_small_3'})
    #####################
    cmd_dict={}
